...
<head>
    ...
    <link rel="website icon" href="{{ asset('assets/images/logodvtgpt.png') }}" type="png">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand d-flex align-items-center" href="#home">
                <img src="{{ asset('assets/images/logodvtgpt.png') }}" alt="PTN MAI Logo" class="me-2"
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-actions">
                    <a href="{{ route('search') }}" class="btn-hero btn-primary-custom">
                        <i class="fas fa-search me-2"></i>Mulai Pencarian
                    </a>
                    <a href="{{ route('login') }}" class="btn-hero btn-outline-custom">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="team-card animate-on-scroll">
                        <img src="{{ asset('assets/images/gw.jpg') }}" alt="Aryansyah M" class="team-image" loading="lazy">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-card animate-on-scroll">
                        <img src="{{ asset('assets/images/atiqqudin.jpg') }}" alt="M Atiqudin" class="team-image" loading="lazy">
        ...
        <div class="container">
            ...
            <div class="text-center mt-5">
                ...
                <div class="support-logos">
                    <img src="{{ asset('assets/images/logo MA remove bg.png') }}" alt="Support Logo 1" class="support-logo" />
                    <img src="{{ asset('assets/images/logodvt.jpg') }}" alt="Support Logo 2" class="support-logo" />
                    <img src="{{ asset('assets/images/logoMAI.png') }}" alt="Support Logo 3" class="support-logo" />
                </div>
            </div>
